...
//Clono il template dalla pagina
...
templateCurrentImage.querySelector('.text h3').innerHTML =  images[currentImageIndex].title;
templateCurrentImage.querySelector('.text p').innerHTML =  images[currentImageIndex].text;